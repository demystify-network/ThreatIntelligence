import { onTransaction } from '../src/index';
...
describe('onTransaction', () => {
    it('Should return result as expected with all attributes', async () => {
        ...
        mockedGetInsights.mockResolvedValue({ 
            ...
            "riskScore": "10.00", 
            "transactionTraces": { 
                "topCreditsByRisk": [{ "id": "0", "address": "905b63fff465b9ffbf41dea908ceb12478ec7601", "category": "MIXER", "tags": "tornado.cash,exploiter", "directTransfer": { "amount": "0.00" }, "indirectTransfers": { "totalPaths": 201, "estimatedAmount": "44.20" } }, { "id": "1", "address": "2e9494387868eb9ec6997b711d655de82f53713f", "category": "GAMBLING", "tags": "findtherabbit.me", "directTransfer": { "amount": "0.00" }, "indirectTransfers": { "totalPaths": 10, "estimatedAmount": "0.73" } }], 
                "topDebitsByRisk": [{ "id": "0", "address": "5acc84a3e955bdd76467d3348077d003f00ffb97", "category": "EXPLOITER", "tags": "forsage.io", "directTransfer": { "amount": "0.00" }, "indirectTransfers": { "totalPaths": 4, "estimatedAmount": "0.02" } }, { "id": "1", "address": "905b63fff465b9ffbf41dea908ceb12478ec7601", "category": "MIXER", "tags": "tornado.cash,exploiter", "directTransfer": { "amount": "0.00" }, "indirectTransfers": { "totalPaths": 22, "estimatedAmount": "0.97" } }, { "id": "2", "address": "4e8ecf79ade5e2c49b9e30d795517a81e0bf00b8", "category": "LOTTERY,GAMBLING", "tags": "fomo3d", "directTransfer": { "amount": "0.00" }, "indirectTransfers": { "totalPaths": 1, "estimatedAmount": "0.00" } }] 
            } 
        });
        ...
        expect(riskScorePanelChildren.length).toBe(8);

        assertTextFiled(riskScorePanelChildren[0], '**Risk Score**: High');
        assertTextFiled(riskScorePanelChildren[2], '**Category**: MIXER,US_GOV_BLOCKED');
        assertTextFiled(riskScorePanelChildren[3], '**Intel**: tornado.cash,exploiter')
        assertTextFiled(riskScorePanelChildren[4], '**Social Media Reports**: No Reports')
        assertTextFiled(riskScorePanelChildren[5], '**Illicit Funds**: 15.46%')
        assertTextFiled(riskScorePanelChildren[7], '**Potentially Risky Transfers (ETH)**')
        ...
        expect(incomeExpensePanelChildren.length).toBe(15);
